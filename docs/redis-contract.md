...
target progress, direction, fill, and latest managed stop. It allows cTrader
reconciliation to resume partial TPs and monotonic trailing after restart while
...
owner through the dedicated signal bot, including sizing/account warnings and
