...
from app.dedup import get_manual_signal
from app.keyboards import build_tp_close_kb, _partial_kb
from app.parsing import _is_owner_cb
from app.symbols import symbol_for_channel
from app.trade_ops import do_close, render_result
